...
class ChatClient(CTk):
    def __init__(self):
        ...
        img = CTkImage(light_image=Image.open("C:\\Users\\Honor\\Desktop\\Python\\GUI\\LogikaTalk\\smooth-elegant-gradient-purple-background-well-using-as-design_1258-331.avif"),size=(500,500))
        ...
        self.chat_entry.configure(fg_color="red")
